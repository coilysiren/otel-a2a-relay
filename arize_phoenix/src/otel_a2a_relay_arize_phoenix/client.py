...
from otel_a2a_relay_core.telemetry import make_provider

from otel_a2a_relay_arize_phoenix.phoenix import DEFAULT_PHOENIX_URL
from otel_a2a_relay_arize_phoenix.phoenix import attrs as _attrs
from otel_a2a_relay_arize_phoenix.phoenix import fetch_spans as _fetch_spans
from otel_a2a_relay_arize_phoenix.phoenix import flatten as _flatten
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not argv:
        print(
            "usage: python -m otel_a2a_relay_arize_phoenix.client {send|view|get|tasks|cancel}",
            file=sys.stderr,
        )
        return 2
    verb = argv[0]
